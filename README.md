...
| 模块 | 用途 |
| --- | --- |
| 学期目录 | 秋季、春季、夏季分别维护课程目录；支持导入 XLSX，并通过 IndexedDB 保存在本机 |
| 课程检索 | 按课程号、课程名、教师、类别、考核方式等条件筛选课程 |
| 已选课程 | 管理当前方案，查看课程号、教师、上课时间和考核方式，并标记专业类学位课 |
| 备选课程 | 先收藏候选课程，随时查看它与当前主选课程的冲突情况 |
| 学期课表 | 按教学周查看完整安排；点击课表即可选定待查询时间段 |
| 按上课时间推荐 | 选择星期、节次和可选周号，优先展示不冲突课程，再展示冲突课程及原因 |
| 暂存存档 | 保存多个选课方案，之后可以读取、更新或另存为新方案；存档包含多学期状态 |

页面顶部还会跨学期汇总学分进度、专业类课程和学位课进度，以及闭卷、开卷、大开卷、读书报告等考核方式分布，方便快速检查整体安排。课表还可按当前学期生成包含课程号、教师和教学周的 Apple 日历 ICS 文件。
